...
1. **Quantified close.** Replace the un-numbered ending with the *measured* **64s-verdict vs 35-min-manual ≈ 97% faster on an exception** [`ARCHITECTURE.md:191`; baseline is illustrative, label it], paired with one clearly-labeled modeled figure (~1.5 FTE / ~$187k/yr). Lifts **Business Impact 2.5 → 4**. Highest ROI single change.
