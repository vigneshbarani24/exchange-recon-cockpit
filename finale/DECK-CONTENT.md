...
Supplier invoice → **matching + variance agents** (read S/4 over MCP · read-only) → **deterministic tolerance gate** → **human Approve/Escalate** (Action Center) → **prepared correction, held**.
